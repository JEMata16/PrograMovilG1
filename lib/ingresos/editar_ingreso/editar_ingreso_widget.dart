...
import 'editar_ingreso_model.dart';
export 'editar_ingreso_model.dart';

class EditarIngresoWidget extends StatefulWidget {
  const EditarIngresoWidget({
    super.key,
    required this.ingreso,
  });

  final IngresosRecord? ingreso;

  @override
  State<EditarIngresoWidget> createState() => _EditarIngresoWidgetState();
}

class _EditarIngresoWidgetState extends State<EditarIngresoWidget> {
  late EditarIngresoModel _model;
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (confirmDialogResponse) {
                          await widget.ingreso!.reference.delete();
                        }
                      },
