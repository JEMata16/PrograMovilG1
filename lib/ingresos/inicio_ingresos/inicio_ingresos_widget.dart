...
import 'inicio_ingresos_model.dart';
export 'inicio_ingresos_model.dart';

class InicioIngresosWidget extends StatefulWidget {
  const InicioIngresosWidget({super.key});

  @override
  State<InicioIngresosWidget> createState() => _InicioIngresosWidgetState();
}

class _InicioIngresosWidgetState extends State<InicioIngresosWidget>
    with TickerProviderStateMixin {
  late InicioIngresosModel _model;
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('IngresosPersonales');
                      },
                      child: Text(
                        'Ver todos',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                    ...
                                    SlidableAction(
                                      ...
                                      onPressed: (_) async {
                                        ...
                                        if (confirmDialogResponse) {
                                          await listViewIngresosRecord.reference
                                              .delete();
                                        }
                                      },
                                    ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('IngresosFamiliares');
                      },
                      child: Text(
                        'Ver todos',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                            ...
                                            await showDialog<bool>(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      content: Text(
                                                          '¿Desea eliminar el gasto de${listViewIngresosRecord.perfil}?'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
