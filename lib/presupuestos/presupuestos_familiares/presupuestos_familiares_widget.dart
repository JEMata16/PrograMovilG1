...
import 'presupuestos_familiares_model.dart';
export 'presupuestos_familiares_model.dart';

class PresupuestosFamiliaresWidget extends StatefulWidget {
  const PresupuestosFamiliaresWidget({super.key});

  @override
  State<PresupuestosFamiliaresWidget> createState() =>
      _PresupuestosFamiliaresWidgetState();
}

class _PresupuestosFamiliaresWidgetState
    extends State<PresupuestosFamiliaresWidget> with TickerProviderStateMixin {
  late PresupuestosFamiliaresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PresupuestosFamiliaresModel());
                                                ...
                                                await showDialog<bool>(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          ...
                                                          content: Text(
                                                              '¿Desea eliminar el ingreso de${listViewPresupuestosRecord.perfil}?'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
