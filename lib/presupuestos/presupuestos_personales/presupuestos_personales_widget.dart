...
class PresupuestosPersonalesWidget extends StatefulWidget {
  const PresupuestosPersonalesWidget({super.key});

  @override
  State<PresupuestosPersonalesWidget> createState() =>
      _PresupuestosPersonalesWidgetState();
}

class _PresupuestosPersonalesWidgetState
    extends State<PresupuestosPersonalesWidget> with TickerProviderStateMixin {
  late PresupuestosPersonalesModel _model;
