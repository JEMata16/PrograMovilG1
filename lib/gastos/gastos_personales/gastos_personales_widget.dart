...
import 'gastos_personales_model.dart';
export 'gastos_personales_model.dart';

class GastosPersonalesWidget extends StatefulWidget {
  const GastosPersonalesWidget({super.key});

  @override
  State<GastosPersonalesWidget> createState() => _GastosPersonalesWidgetState();
}

class _GastosPersonalesWidgetState extends State<GastosPersonalesWidget>
    with TickerProviderStateMixin {
  late GastosPersonalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GastosPersonalesModel());
