...
import 'inicio_gastos_model.dart';
export 'inicio_gastos_model.dart';

class InicioGastosWidget extends StatefulWidget {
  const InicioGastosWidget({super.key});

  @override
  State<InicioGastosWidget> createState() => _InicioGastosWidgetState();
}

class _InicioGastosWidgetState extends State<InicioGastosWidget>
    with TickerProviderStateMixin {
  late InicioGastosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicioGastosModel());
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('GastosPersonales');
                      },
                      child: Text(
                        'Ver todos',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
              ...
              Padding(
                ...
                child: StreamBuilder<List<GastosRecord>>(
                  stream: queryGastosRecord(
                    queryBuilder: (gastosRecord) => gastosRecord.where(
                      'perfil',
                      isEqualTo: 'Personal',
                    ),
                    limit: 3,
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<GastosRecord> listViewGastosRecordList =
                        snapshot.data!;
                    if (listViewGastosRecordList.isEmpty) {
                    ...
                    return ListView.separated(
                      ...
                      itemCount: listViewGastosRecordList.length,
                      separatorBuilder: (_, __) => const SizedBox(height: 4.0),
                      itemBuilder: (context, listViewIndex) {
                        final listViewGastosRecord =
                            listViewGastosRecordList[listViewIndex];
                        return Align(
                          alignment: const AlignmentDirectional(-1.0, -1.0),
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'gasto': serializeParam(
                                      listViewGastosRecord,
                                      ParamType.Document,
                                    ),
                                  }.withoutNulls,
                                  extra: <String, dynamic>{
                                    'gasto': listViewGastosRecord,
                                  },
                                );
                              },
                              child: Slidable(
                                    ...
                                    SlidableAction(
                                      ...
                                      onPressed: (_) async {
                                        ...
                                        if (confirmDialogResponse) {
                                          await listViewGastosRecord.reference
                                              .delete();
                                        }
                                      },
                                    ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('GastosFamiliares');
                      },
                      child: Text(
                        'Ver todos',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                          ...
                                          var confirmDialogResponse =
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: const Text(
                                                            'Eliminar gasto familiar'),
                                                        content: Text(
                                                            '¿Desea eliminar el gasto de ${listViewGastosRecord.perfil}?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
