...
import 'deudas_familiares_model.dart';
export 'deudas_familiares_model.dart';

class DeudasFamiliaresWidget extends StatefulWidget {
  const DeudasFamiliaresWidget({super.key});

  @override
  State<DeudasFamiliaresWidget> createState() => _DeudasFamiliaresWidgetState();
}

class _DeudasFamiliaresWidgetState extends State<DeudasFamiliaresWidget>
    with TickerProviderStateMixin {
  late DeudasFamiliaresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeudasFamiliaresModel());
