...
import 'editar_deuda_model.dart';
export 'editar_deuda_model.dart';

class EditarDeudaWidget extends StatefulWidget {
  const EditarDeudaWidget({
    super.key,
    required this.deudas,
  });

  final DeudasRecord? deudas;

  @override
  State<EditarDeudaWidget> createState() => _EditarDeudaWidgetState();
}

class _EditarDeudaWidgetState extends State<EditarDeudaWidget> {
  late EditarDeudaModel _model;
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller: _model.dropDownTipoValueController ??=
                              FormFieldController<String>(
                            _model.dropDownTipoValue ??= widget.deudas?.tipo,
                          ),
                          options: const [
                            'Mensual',
                            'Bimensual',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              final datePickedDate = await showDatePicker(
                                context: context,
                                initialDate: (widget.deudas?.fechaPago ??
                                    DateTime.now()),
                                firstDate: (widget.deudas?.fechaPago ??
                                    DateTime.now()),
