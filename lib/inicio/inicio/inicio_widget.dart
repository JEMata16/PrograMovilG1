            ...
            children: [
              ...
              Padding(
                ...
                child: StreamBuilder<List<FamiliaresRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<FamiliaresRecord> listViewFamiliaresRecordList =
                        snapshot.data!;
                    return ListView.separated(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewFamiliaresRecordList.length,
                      separatorBuilder: (_, __) => const SizedBox(height: 4.0),
                      itemBuilder: (context, listViewIndex) {
                        final listViewFamiliaresRecord =
                            listViewFamiliaresRecordList[listViewIndex];
                        return Align(
                          alignment: const AlignmentDirectional(-1.0, -1.0),
                          child: ListTile(
                            title: Text(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Historial de ingresos y gastos recientes',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Lato',
                            color: const Color(0xFF41697D),
                            fontSize: 16.0,
                ...
                child: StreamBuilder<List<GastosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewGastosRecord =
                        listViewGastosRecordList.isNotEmpty
                            ? listViewGastosRecordList.first
                            : null;
                    return ListView(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                ...
                child: StreamBuilder<List<IngresosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewIngresosRecord =
                        listViewIngresosRecordList.isNotEmpty
                            ? listViewIngresosRecordList.first
                            : null;
                    return ListView(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
